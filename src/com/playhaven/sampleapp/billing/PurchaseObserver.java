...
public abstract class PurchaseObserver {
    ...
    private boolean mShouldShowMarket;
    ...
    protected boolean getShouldShowMarket() {
    	return mShouldShowMarket;
    }
    
    protected void setShouldShowMarket(boolean shouldShowMarket) {
    	mShouldShowMarket = shouldShowMarket;
    }
    
    protected void startBuyPageActivity(PendingIntent pendingIntent, Intent intent) {
    	if (! getShouldShowMarket())  return; // often used when testing
